  ...
  <div class="container-fluid page-body-wrapper">
    ...
    <div class="main-panel">
      ...
      <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg width-ctrl">
                ...
                <div class="profile-form  col-lg-8" style="margin-top:0;">
                  ...
                  <div class="form-group">
                    ...
                    <select class="js-example-basic-single w-100">
                      <option value="AL">Role 1</option>
                      <option value="WY">Role 2</option>
                      <option value="AM">Role 3</option>
                      <option value="CA">Role 4</option>
                      <option value="RU">Role 5</option>
                    </select>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Password">
                  </div>
                </div>
