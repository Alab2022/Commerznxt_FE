													...
													<div class="col-lg-12 d-flex flex-column">
														<div class="row flex-grow">
																			...
																			<div class="d-flex justify-content-between">
																				<div class="d-flex align-items-center">
																					...
																					<div class="col-auto  mright-10">
																						<input type="password" id="inputPassword6" class="form-control  mright-10" aria-describedby="passwordHelpInline"> </div>
																					<div class="col-auto">
															...
															<div class="d-flex align-items-center justify-content-between">
																<div> </div>
																<div class="d-flex">
																	<div class="btn-wrapper me-10"> <a href="#" class="btn btn-primary btn-lg btn-white btn-pad" data-bs-toggle="modal" data-bs-target="#paymentplan">View Payment Plan</a> <a href="#" class="btn btn-primary btn-lg btn-white btn-pad">Send for Approval</a> <a href="#" class="btn btn-primary btn-lg btn-white btn-pad">Save & Send Email</a> <a href="#" class="btn btn-primary btn-lg btn-white btn-pad">Save</a> </div>
																</div>
															</div>
														</div>
													</div>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<div class="mb-3 row">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" id="inputPassword"> </div>
										</div>
										<div class="mb-3 row">
