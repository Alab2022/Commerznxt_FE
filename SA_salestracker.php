											...
											<ul class="nav nav-tabs" id="myTab" role="tablist">
												<li class="nav-item txt_orange" role="presentation">
													<button class="nav-link active" id="new-tab" data-bs-toggle="tab" data-bs-target="#new" type="button" role="tab" aria-controls="home" aria-selected="true">
														<icon class="mdi mdi-shopping"></icon> E-Commerce sales </button>
												</li>
												<li class="nav-item txt_blue" role="presentation">
													<button class="nav-link" id="inp-tab" data-bs-toggle="tab" data-bs-target="#inp" type="button" role="tab" aria-controls="profile" aria-selected="false">
														<icon class="mdi mdi-tag"></icon> Direct Sales </button>
												</li>
												<li class="nav-item txt_green" role="presentation">
													<button class="nav-link" id="quotes-tab" data-bs-toggle="tab" data-bs-target="#quotes" type="button" role="tab" aria-controls="contact" aria-selected="false">
														<icon class="mdi mdi-account"></icon> Independent sales rep </button>
												</li>
												<li class="nav-item dropdown d-none d-lg-block user-dropdown fo-SA"> <a class="nav-link custom" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              Choose Filter <span><i class="mdi mdi-filter-variant"></i></span></a>
													<div class="dropdown-menu dropdown-menu-right navbar-dropdown tb-header" aria-labelledby="UserDropdown">
														<div class="dropdown-header">
															<h5>Choose Filter <span><a href="#">Clear all</a></span></h5> </div>
														...
														<div class="col-lg-12 d-flex flex-column">
															<div class="row flex-grow">
																<div class="col-12 grid-margin stretch-card">
																	<div class="card card-rounded">
																		<div class="card-body fo-nopad">
																			<div class="d-sm-flex justify-content-between align-items-start">
																				<div>
																					<h4 class="card-title card-title-dash">Sales 2021 - 2022</h4> </div>
																			</div>
																			...
																			<div class="table_wrapper" style="margin-top: 35px;border-top:1px solid #ddd;padding-top:35px">
																				<div class="table_header">
																					<h4 class="card-title">E-Commerce Sales</h4>
																					<div class="cv-right">
																						<div class="fo-search">
																...
																<div class="col-12 grid-margin stretch-card">
																	<div class="card card-rounded">
																		<div class="card-body fo-nopad">
																			...
																			<div class="table_wrapper" style="margin-top: 35px;border-top:1px solid #ddd;padding-top:35px">
																				<div class="table_header">
																					<h4 class="card-title">Direct sales</h4>
																					<div class="cv-right">
																						<div class="fo-search">
																							<div class="form-group">
																								<input type="text" placeholder="Search"> <span><img class="icon-font" src="images/search.svg"></span> </div>
																...
																<div class="col-12 grid-margin stretch-card">
																	<div class="card card-rounded">
																		<div class="card-body fo-nopad">
																			<div class="d-sm-flex justify-content-between align-items-start">
																				<div>
																					<h4 class="card-title card-title-dash">Independent sales rep</h4> </div>
																			</div>
																			<div class="d-sm-flex align-items-center mt-1 justify-content-between">
																				<div class="d-sm-flex align-items-center mt-4 justify-content-between">
																					<h2 class="me-2 fw-bold">$36,2531.00</h2>
																			...
																			<div class="chartjs-bar-wrapper mt-3">
																				<canvas id="marketingOverview3"></canvas>
																			</div>
																			<div class="table_wrapper" style="margin-top: 35px;border-top:1px solid #ddd;padding-top:35px">
																				<div class="table_header">
																					<h4 class="card-title">E-Commerce Sales</h4>
