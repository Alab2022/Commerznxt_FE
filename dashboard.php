													...
													<div class="col-sm-12">
														<div class="statistics-details d-flex align-items-center justify-content-between dashbrd flex-sm-row flex-column">
															...
															<div class="card card-rounded">
																<div class="card-body">
																	<div class="d-flex align-items-center mb-2 mb-sm-0">
																		...
																		<div>
																			<h3 class="rate-percentage">4.5M</h3>
															...
															<div class="card card-rounded">
																<div class="card-body">
																	<div class="d-flex align-items-center mb-2 mb-sm-0">
																		<div class="icon_home four"> <span><img src="images/activity/payment.svg" alt="image"></span> </div>
																		<div>
																			<h3 class="rate-percentage">2.1M</h3>
															...
															<div class="card card-rounded">
																<div class="card-body">
																	<div class="d-flex align-items-center mb-2 mb-sm-0">
																		<div class="icon_home five"> <span><img src="images/activity/creditgiven.svg" alt="image"></span> </div>
																		<div>
																			<h3 class="rate-percentage">3K</h3>
																			<p class="text-small mb-2"><a href="IA_totalsales&credit.php">Credit Given</a></p>
																		</div>
																	</div>
																</div>
															</div>
																...
																<div class="card card-rounded">
																	<div class="card-body">
																		<div class="d-sm-flex justify-content-between align-items-start">
																			<div>
																				<h4 class="card-title card-title-dash">Profit Overview</h4> </div>
																		...
																		<div class="row">
																			<div class="col-lg-12">
																				<div class="d-flex justify-content-between align-items-center mb-3">
																					<h4 class="card-title card-title-dash">Geography Orders</h4> </div>
															...
															<div class="col-12 grid-margin stretch-card">
																<div class="card card-rounded">
																	<div class="card-body">
																		<div class="d-sm-flex justify-content-between align-items-start">
																			<div>
																				<h4 class="card-title card-title-dash">Sales Overview</h4> </div>
																		</div>
																		<div class="d-sm-flex align-items-center mt-1 justify-content-between">
																			<div class="d-sm-flex align-items-center mt-4 justify-content-between">
																				<h2 class="me-2 fw-bold">$36,2531.00</h2>
																				<h4 class="me-2">GBP</h4>
																...
																<div class="card card-rounded">
																	<div class="card-body card-rounded">
																		...
																		<div class="list align-items-center border-bottom py-2">
																			<div class="wrapper w-100 d-flex justify-content-between mt-3">
																				<div>
																					<p class="mb-1 font-weight-medium"> Ada Loveace </p>
																					<div class="d-flex justify-content-between align-items-center">
																						<div class="d-flex align-items-center">
																							<p class="mb-0 text-small text-muted">Order Date: Mar 14, 2019 </p>
																						</div>
																					</div>
																				</div>
																		...
																		<div class="list align-items-center border-bottom py-2">
																			<div class="wrapper w-100 d-flex justify-content-between">
																				<div>
																					<p class="mb-1 font-weight-medium"> Grace Hopper </p>
																					<div class="d-flex justify-content-between align-items-center">
																						<div class="d-flex align-items-center">
																							<p class="mb-0 text-small text-muted">Order Date: Mar 14, 2019</p>
																						</div>
																				...
																				<div class="text-muted text-small">
																					<div class="badge badge-opacity-success">Order Placed</div>
																				</div>
																			</div>
																		</div>
																		<div class="list align-items-center border-bottom py-2">
																			<div class="wrapper w-100 d-flex justify-content-between">
																				<div>
																					<p class="mb-1 font-weight-medium"> Magaret Hamilton </p>
																					<div class="d-flex justify-content-between align-items-center">
																						<div class="d-flex align-items-center">
																							<p class="mb-0 text-small text-muted">Order Date: Mar 14, 2019</p>
																						</div>
																				...
																				<div class="text-muted text-small">
																					<div class="badge badge-opacity-warning">Shipped</div>
																				</div>
																			</div>
																		</div>
																		<div class="list align-items-center border-bottom py-2">
																			<div class="wrapper w-100 d-flex justify-content-between">
																				<div>
																					<p class="mb-1 font-weight-medium"> Matthew Bailey </p>
																					<div class="d-flex justify-content-between align-items-center">
																						<div class="d-flex align-items-center">
																							<p class="mb-0 text-small text-muted">Order Date: Mar 14, 2019</p>
																						</div>
																				...
																				<div class="text-muted text-small">
																					<div class="badge badge-opacity-success">Deivered</div>
																				</div>
																			</div>
																		</div>
																	...
																	<div class="card-body">
																		<div class="row">
																			<div class="col-lg-12">
																				<div class="d-flex justify-content-between align-items-center mb-3">
																					<div>
																						<h4 class="card-title card-title-dash">Purchase Detail</h4> </div>
																				</div>
																				<div class="mt-3">
																					<div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
																						<div class="d-flex"> <img class="img-sm rounded-10" src="images/faces/face1.jpg" alt="profile">
																							<div class="wrapper ms-3">
																								<p class="ms-1 mb-1 fw-bold">Brandon Washington</p> <small class="text-muted mb-0">162543</small> </div>
																						</div>
																						<div class="text-muted text-small"> 1500 GBP </div>
																					</div>
																					<div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
																						<div class="d-flex"> <img class="img-sm rounded-10" src="images/faces/face2.jpg" alt="profile">
																							<div class="wrapper ms-3">
																								<p class="ms-1 mb-1 fw-bold">Wayne Murphy</p> <small class="text-muted mb-0">162543</small> </div>
																						</div>
																						<div class="text-muted text-small"> 1250 GBP </div>
																					</div>
																					<div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
																						<div class="d-flex"> <img class="img-sm rounded-10" src="images/faces/face3.jpg" alt="profile">
																							<div class="wrapper ms-3">
																								<p class="ms-1 mb-1 fw-bold">Katherine Butler</p> <small class="text-muted mb-0">162543</small> </div>
																						</div>
																						<div class="text-muted text-small"> 3200 GBP </div>
																					</div>
																					<div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
																						<div class="d-flex"> <img class="img-sm rounded-10" src="images/faces/face4.jpg" alt="profile">
																							<div class="wrapper ms-3">
																								<p class="ms-1 mb-1 fw-bold">Matthew Bailey</p> <small class="text-muted mb-0">162543</small> </div>
																						</div>
																						<div class="text-muted text-small"> 1580 GBP </div>
																					</div>
																				</div>
																			</div>
																		</div>
																...
																<div class="card card-rounded">
																	<div class="card-body">
																		<div class="row">
																			<div class="col-lg-12">
																				<div class="d-flex justify-content-between align-items-center">
																					<h4 class="card-title card-title-dash">Credit given & Payment status</h4>
																					...
																					<ul class="todo-list todo-list-rounded">
																						<li class="d-block">
																							<div class="form-check w-100">
																								<p class="mb-2 font-weight-medium"> Percepta security <span>(Ecommerce)</span></p>
																								<div class="d-flex mt-2">
																									<div class="text-small me-3">Inv.Date - 24 June 2020</div>
																									<div class="badge badge-opacity-warning me-3">Credit Days Left - 10</div>
																								</div>
																							</div>
																						</li>
																						<li class="d-block">
																							<div class="form-check w-100">
																								<p class="mb-2 font-weight-medium"> Exela Movers <span>(Direct)</span></p>
																								<div class="d-flex mt-2">
																									<div class="text-small me-3">Inv.Date - 23 June 2020</div>
																									<div class="badge badge-opacity-success me-3">Credit Days Left - 30</div>
																								</div>
																							</div>
																						</li>
																						<li class="border-bottom-0">
																							<div class="form-check w-100">
																								<p class="mb-2 font-weight-medium"> Intrepid Travel <span>(Ecommerce)</span></p>
																								<div class="d-flex mt-2">
																									<div class="text-small me-3">Inv.Date - 24 June 2020</div>
																									<div class="badge badge-opacity-danger me-3">Credit Days Left - 0</div>
																								</div>
																							</div>
																						</li>
																					</ul>
																		...
																		<div class="row">
																			<div class="col-sm-6">
																				<div class="d-flex justify-content-between align-items-center mb-2 mb-sm-0">
																					...
																					<div>
																						<p class="text-small mb-2">Quotation</p>
																						<h4 class="mb-0 fw-bold">20</h4> </div>
																				</div>
																			</div>
																			<div class="col-sm-6">
																				<div class="d-flex justify-content-between align-items-center">
																					...
																					<div>
																						<p class="text-small mb-2">Invoice</p>
																						<h4 class="mb-0 fw-bold">35</h4> </div>
																				</div>
																			</div>
																		</div>
																	</div>
																	...
																	<div class="card-body">
																		<div class="row">
																			<div class="col-lg-12">
																				<div class="d-flex justify-content-between align-items-center mb-3">
																					<div>
																						<h4 class="card-title card-title-dash">Category Wise Quotation</h4> </div>
																					<div>
																						<!-- <div class="dropdown">
