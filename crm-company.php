              ...
              <div class="d-flex align-items-center justify-content-between mb-2">
                ...
                <div class="d-flex">
                  <div class="btn-wrapper mright-10">
                    ...
                    <a href="#" class="btn btn-primary text-white me-10 d-flex" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="icon-plus"></i> Add</a>
                  </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="row g-3">
            ...
            <div class="col-md-4">
              <label for="inputPassword4" class="form-label">Upload logo</label>
              <input class="form-control form-control-sm" id="formFileSm" type="file">
            </div>
            <div class="col-md-4">
              <label for="inputState" class="form-label">Company type</label>
            ...
            <div class="col-md-4">
              <label for="inputPassword4" class="form-label">Industry</label>
              <input type="password" class="form-control" id="inputPassword4">
            </div>
            <div class="col-md-4">
              <label for="inputPassword4" class="form-label">Annual revenue</label>
              <input type="password" class="form-control" id="inputPassword4">
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              <label for="inputState" class="form-label">Messager</label>
              <select id="inputState" class="form-select">
                <option selected>Choose...</option>
                <option>...</option>
              </select>
            ...
            <div class="col-md-4">
              <label for="inputState" class="form-label">Company contact</label>
