												...
												<div class="row">
													<div class="col-lg-12 d-flex flex-column">
														<div class="row flex-grow">
															...
															<div class="d-flex align-items-center justify-content-between border-bottom">
																<div> </div>
																<div class="d-flex align-items-center"> <a href="#" class="btn btn-primary btn-lg btn-white btn-pad btn-hold mright-10" data-bs-toggle="modal" data-bs-target="#hold">Hold <i><img src="images/activity/hold.svg" alt="image"></i></a> <a href="#" class="btn btn-primary btn-lg btn-white btn-pad mright-10">Save & Send Email</a> <a href="#" class="btn btn-primary btn-lg btn-white btn-pad">Save</a> </div>
															</div>
														</div>
													</div>
												</div>
