									...
									<div class="home-tab">
										<div class="d-flex align-items-center justify-content-between">
											<div>
												<h4>Quotes</h4> </div>
											<div class="d-flex">
												<div class="btn-wrapper me-10 mright-10"> <a href="se-crm-quotes.php" class="btn btn-primary text-white me-10 d-flex"><i class="icon-plus"></i> Add</a> </div>
													...
													<div class="col-lg-12 d-flex flex-column">
														<div class="row flex-grow">
																...
																<div class="card card-rounded">
																	<div class="card-body">
																		<div class="row g-3 align-items-center quotes-top justify-content-between">
																			...
																			<div class="col-auto d-flex justify-content-end">
																				<button type="button" class="btn btn-primary mright-10"> <i class="mdi mdi-plus"></i> </button>
															...
															<div class="d-flex align-items-center justify-content-between">
																<div> </div>
																<div class="d-flex">
																	<div class="btn-wrapper me-10"> <a href="#" class="btn btn-primary btn-lg btn-white btn-pad">Send for Approval</a> <a href="#" class="btn btn-primary btn-lg btn-white btn-pad">Save & Send Email</a> <a href="#" class="btn btn-primary btn-lg btn-white btn-pad">Save</a> </div>
																</div>
															</div>
														</div>
													</div>
