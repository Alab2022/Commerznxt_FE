                                  ...
                                  CEO.ComerceNxt
																	...
																	<div class="card-body overview">
																		<ul class="nav nav-tabs nav-activity" id="myTab" role="tablist">
																			<li class="nav-item text-center txt_purple" role="presentation">
																				<button class="nav-link co active btn-purple" id="new-tab" data-bs-toggle="tab" data-bs-target="#new" type="button" role="tab" aria-controls="home" aria-selected="true"> <i><img src="images/activity/activity.svg" alt="image"></i> Activity </button>
																			</li>
																			<li class="nav-item text-center txt_blue" role="presentation">
																				<button class="nav-link co btn-blue" id="inp-tab" data-bs-toggle="tab" data-bs-target="#inp" type="button" role="tab" aria-controls="profile" aria-selected="false"> <i><img src="images/activity/comments.svg" alt="image"></i> Comments </button>
																			</li>
																			<li class="nav-item text-center txt_red" role="presentation">
																				<button class="nav-link co btn-red" id="quotes-tab" data-bs-toggle="tab" data-bs-target="#quotes" type="button" role="tab" aria-controls="contact" aria-selected="false"> <i><img src="images/activity/email.svg" alt="image"></i> Email </button>
																			</li>
																			<li class="nav-item text-center txt_green" role="presentation">
																				<button class="nav-link co btn-green" id="won-tab" data-bs-toggle="tab" data-bs-target="#won" type="button" role="tab" aria-controls="contact" aria-selected="false"> <i><img src="images/activity/quote.svg" alt="image"></i> Quotes </button>
																			</li>
																			<li class="nav-item  text-center txt_orange" role="presentation">
																				<button class="nav-link co btn-orange" id="lost-tab" data-bs-toggle="tab" data-bs-target="#lost" type="button" role="tab" aria-controls="contact" aria-selected="false"> <i><img src="images/activity/orders.svg" alt="image"></i> Orders </button>
																			</li>
																			<li class="nav-item  text-center txt_blue" role="presentation">
																				<button class="nav-link co btn-blue" id="invoice-tab" data-bs-toggle="tab" data-bs-target="#invoice" type="button" role="tab" aria-controls="contact" aria-selected="false"> <i><img src="images/activity/invoice.svg" alt="image"></i> Invoice </button>
																			</li>
																			<li class="nav-item  text-center txt_purple" role="presentation">
																				<button class="nav-link co btn-purple" id="lost-tab" data-bs-toggle="tab" data-bs-target="#lost" type="button" role="tab" aria-controls="contact" aria-selected="false"> <i><img src="images/activity/calls.svg" alt="image"></i> Calls </button>
																			</li>
																			<li class="nav-item text-center dropdown txt_d_blue" role="presentation">
																				<button class="nav-link co btn-d-blue" id="sms-tab" data-bs-toggle="tab" data-bs-target="#sms" type="button" role="tab" aria-controls="contact" aria-selected="false"> <i><img src="images/activity/sms.svg" alt="image"></i> SMS </button>
																			</li>
																			<li class="nav-item text-center dropdown txt_d_green" role="presentation">
																				<button class="nav-link co btn-d-green" id="lost-tab" data-bs-toggle="tab" data-bs-target="#lost" type="button" role="tab" aria-controls="contact" aria-selected="false"> <i><img src="images/activity/whatsapp.svg" alt="image"></i> Whatsapp </button>
																			</li>
																			<li class="nav-item text-center dropdown txt_yellow" role="presentation">
																				<button class="nav-link co btn-d-yellow" id="lost-tab" data-bs-toggle="tab" data-bs-target="#lost" type="button" role="tab" aria-controls="contact" aria-selected="false"> <i><img src="images/activity/event.svg" alt="image"></i> Event </button>
																			</li>
																		</ul>
																	</div>
																</div>
                                          ...
                                          <i class="icon_timeline btn-d-yellow"><img src="images/activity/email.svg" alt="image"></i>
																							...
																							<div class="vertical-timeline-element-content bounce-in">
																								...
																								<p>Meeting with USA Client, today at <a href="javascript:void(0);" data-abc="true">12:00 PM</a></p> <span class="vertical-timeline-element-date">9:30 AM</span> </div>
																						</div>
																					</div>
																					<div class="vertical-timeline-item vertical-timeline-element">
																						<div> <span class="vertical-timeline-element-icon bounce-in">
                                          <i class="icon_timeline btn-blue"><img src="images/activity/email.svg" alt="image"></i>
																							...
																							<div class="vertical-timeline-element-content bounce-in">
																								...
																								<p>Yet another one, at <span class="text-success">5:00 PM</span></p> <span class="vertical-timeline-element-date">12:25 PM</span> </div>
																						</div>
																					</div>
																					<div class="vertical-timeline-item vertical-timeline-element">
																						<div> <span class="vertical-timeline-element-icon bounce-in">
                                          <i class="icon_timeline btn-red"><img src="images/activity/email.svg" alt="image"></i>
																							...
																							<div class="vertical-timeline-element-content bounce-in">
																								...
																								<p>meeting with team mates about the launch of new product. and tell them about new features</p> <span class="vertical-timeline-element-date">6:00 PM</span> </div>
																						</div>
																					</div>
																					<div class="vertical-timeline-item vertical-timeline-element">
																						<div> <span class="vertical-timeline-element-icon bounce-in">
                                          <i class="icon_timeline btn-orange"><img src="images/activity/email.svg" alt="image"></i>
																							...
																							<div class="vertical-timeline-element-content bounce-in">
																								...
																								<p>Discussion with marketing team about the popularity of last product</p> <span class="vertical-timeline-element-date">9:00 AM</span> </div>
																						</div>
																					</div>
																					<div class="vertical-timeline-item vertical-timeline-element">
																						<div> <span class="vertical-timeline-element-icon bounce-in">
                                          <i class="icon_timeline btn-purple"><img src="images/activity/email.svg" alt="image"></i>
																							...
																							<div class="vertical-timeline-element-content bounce-in">
																								...
																								<p>Purchase new hosting plan as discussed with development team, today at <a href="javascript:void(0);" data-abc="true">10:00 AM</a></p> <span class="vertical-timeline-element-date">10:30 PM</span> </div>
																						</div>
																					</div>
																					<div class="vertical-timeline-item vertical-timeline-element">
																						<div> <span class="vertical-timeline-element-icon bounce-in">
                                          <i class="icon_timeline btn-green"><img src="images/activity/email.svg" alt="image"></i>
																							...
																							<div class="vertical-timeline-element-content bounce-in">
																								...
																								<p>Yet another one, at <span class="text-success">1:00 PM</span></p> <span class="vertical-timeline-element-date">12:25 PM</span> </div>
																						</div>
																					</div>
																					<div class="vertical-timeline-item vertical-timeline-element">
																						<div> <span class="vertical-timeline-element-icon bounce-in">
																				...
																				<div class="comments_wrapper">
																					<div class="top_commment_form d-flex">
																						<div class="cmt-input">
																							...
																							<input height="100" type="text" placeholder="Type you comment here"> </div>
																					</div>
																					<div class="d-flex text-right vendors">
																						<div class="btn-wrapper me-10"> <a href="#" class="btn btn-outline btn-lg btn-white btn-pad">Cancel</a> <a href="#" class="btn btn-primary btn-lg btn-white btn-pad">Save</a>
																							<button type="button" class="btn btn-secondary bl1"> <i class="mdi mdi-attachment"></i> </button>
																						</div>
																					</div>
																					<div class="comments_history">
																						<label for="">History</label>
																						<div class="success-float"> 19th Nov, 2022 </div>
																						<div class="fo-bo-wrap">
																							<h6 style="margin-bottom: 0;">Smple history record</h6> </div>
																					</div>
																				</div>
																			</div>
																						...
																						<div class="home-tab">
																							<div class="d-flex align-items-center justify-content-between border-bottom">
																								<div>
																									<h4>Quotes</h4> </div>
																								<div class="d-flex">
																									<div class="btn-wrapper me-10"> <a href="#" class="btn btn-primary text-white me-10 d-flex"><i class="icon-plus"></i> Add</a> </div>
																										...
																										<div class="col-lg-12 d-flex flex-column">
																											<div class="row flex-grow">
																														...
																														<div class="card-body no-padd">
																															<div class="row g-3 align-items-center quotes-top">
																																...
																																<div class="col-auto">
																																	<input type="password" id="inputPassword6" class="form-control" aria-describedby="passwordHelpInline"> </div>
																																<div class="col-auto">
																																	<button type="button" class="btn btn-danger btn-icon-text" data-bs-toggle="modal" data-bs-target="#exampleModal"> <i class="ti-alert btn-icon-prepend"></i> 1 Pending Action </button>
																																</div>
																																<div class="col-auto d-flex justify-content-end">
																																	<button type="button" class="btn btn-primary"> <i class="mdi mdi-plus"></i> </button>
																																	<button type="button" class="btn btn-primary"> <i class="mdi mdi-minus"></i> </button>
																																</div>
																															</div>
																															<div class="table-responsive">
																																<table class="table table-striped">
																																	<thead>
																																		<tr>
																																			<th>
																																				<input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"> </th>
																																			<th> Product Name </th>
																																			<th> SKU ID </th>
																																			<th> QTY </th>
																																			<th> Price/QTY </th>
																																	...
																																	<tbody>
																																		<tr>
																																			<td>
																																				<input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"> </td>
																																			<td> COMNXT-Q-01 </td>
																												...
																												<div class="d-flex align-items-center justify-content-between border-bottom">
																													<div> </div>
																													<div class="d-flex">
																														<div class="btn-wrapper me-10"> <a href="#" class="btn btn-primary btn-lg btn-white btn-pad">Cancel</a> <a href="#" class="btn btn-primary btn-lg btn-white btn-pad">Save & Send Email</a> <a href="#" class="btn btn-primary btn-lg btn-white btn-pad">Save</a> </div>
																													</div>
																												</div>
																											</div>
																										</div>
																					...
																					<div class="table_wrapper">
																						<div class="table_header">
																							...
																							<div class="cv-right">
																								...
																								<button type="button" class="btn btn-primary btn-icon-text"> View Status </button>
																							</div>
																						</div>
																							...
																							<div class="card card-rounded ">
																								<div class="card-body no-padd">
																									<div class="table-inner-header d-flex">
																										...
																										<div class="mini-buttons">
																											<div class="btn-group" role="group" aria-label="Basic example">
																												<button type="button" class="btn btn-secondary gr2"> <i class="mdi mdi-plus"></i> </button>
																												<button type="button" class="btn btn-secondary bl1"> <i class="mdi mdi-delete"></i> </button>
																											</div>
																										</div>
																									</div>
																									<div class="table-responsive">
																									...
																									<div class="fo-attachments d-flex">
																										<div class="form-group">
																											<input w-100 type="text" class="form-control" id="exampleInputName1" placeholder="Add notes"> </div>
																										<div class="mini-buttons">
																											<div class="btn-group" role="group" aria-label="Basic example">
																												<button type="button" class="btn btn-secondary bl1"> <i class="mdi mdi-attachment"></i> </button>
																											</div>
																						...
																						<div class="d-flex text-right">
																							<div class="btn-wrapper me-10"> <a href="#" class="btn btn-outline btn-lg btn-white btn-pad">Cancel</a> <a href="#" class="btn btn-primary btn-lg btn-white btn-pad">Save</a> </div>
																						</div>
																					</div>
																				</div>
																			</div>
																										...
																										<div class="col-lg-12 d-flex flex-column">
																											<div class="row flex-grow">
																																...
																																<table class="table table-striped">
																																	...
																																	<tbody>
																																		<tr>
																																			<td>
																																				<input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"> </td>
																																			<td> <a href="crm-invoice-det.php"> COMNXT-Q-01</a> </td>
																																			<td> 20000 </td>
																																			<td> 2 </td>
																																		</tr>
																																		<tr>
																												...
																												<div class="d-flex align-items-center justify-content-between border-bottom">
																													<div> </div>
																													<div class="d-flex">
																														<div class="btn-wrapper me-10"> <a href="#" class="btn btn-primary btn-lg btn-white btn-pad">Create Invoice</a> </div>
																													</div>
																												</div>
																											</div>
																										</div>
																				...
																				<div class="comments_wrapper">
																					<div class="top_commment_form d-flex">
																						<div class="cmt-input">
																							...
																							<input height="100" type="text" placeholder="Type here"> </div>
																					</div>
																					<div class="d-flex text-right vendors">
																						<div class="btn-wrapper me-10"> <a href="#" class="btn btn-outline btn-lg btn-white btn-pad">Cancel</a> <a href="#" class="btn btn-primary btn-lg btn-white btn-pad">Send</a> </div>
																					</div>
																				</div>
																			</div>
																		</div>
						...
						<div class="modal-body">
							<form class="row g-3">
								...
								<div class="col-md-4">
									...
									<input type="text" class="form-control" id="inputPassword4"> </div>
								<div class="col-md-4">
